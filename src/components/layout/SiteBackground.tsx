export default function SiteBackground() {
  return (
    ...
    >
      <div
        className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-[.035] sm:opacity-[.05] dark:opacity-[.075]"
        style={{ backgroundImage: "url('/images/fenix-login-desktop.png')" }}
      />
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-white/[.06] via-transparent to-white/[.16] dark:from-black/[.08] dark:via-transparent dark:to-black/[.3]" />
