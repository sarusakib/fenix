...
placeholder="Feni Brain-কে যা ইচ্ছা জিজ্ঞাসা করুন (যেমন: কম টাকায় কাপড়ের ব্যবসা)..."
className="w-full text-gray-800 text-sm sm:text-base outline-none bg-transparent px-2 placeholder-gray-400 font-medium"
/>
<button className="bg-[#008080] hover:bg-[#006666] text-white px-5 py-3 rounded-xl font-medium text-sm sm:text-base flex items-center space-x-2 transition-all shadow-md shrink-0">
<span>খুঁজুন</span>
...
<span className="text-gray-400 font-medium">জনপ্রিয় সার্চ:</span>
...
<h2 className="text-2xl font-bold text-[#0B1736]">কেন FeniX প্ল্যাটফর্ম ব্যবহার করবেন?</h2>
<p className="text-sm text-gray-500 mt-2">ফেনীর স্থানীয় ব্যবসার নিরাপত্তা ও স্বচ্ছতা নিশ্চিত করাই আমাদের প্রথম অগ্রাধিকার</p>
</div>
...
<h4 className="text-lg font-bold text-[#0B1736]">ট্রাফিক লাইট ট্রাস্ট সিস্টেম</h4>
<p className="text-xs text-gray-500">ফিল্ড এজেন্ট দ্বারা সরেজমিনে ভেরিফাইড ব্যবসার তালিকা। গ্রীন ট্যাব দিয়ে সুরক্ষিত ব্যবসা চিনুন।</p>
</div>
​<div className="flex flex-col items-center space-y-3 p-4">
<div className="p-4 bg-amber-50 rounded-full text-amber-600">
<Buildings size={36} weight="duotone" />
</div>
<h4 className="text-lg font-bold text-[#0B1736]">স্থানীয় বিজনেস নেটওয়ার্ক</h4>
<p className="text-xs text-gray-500">ফেনীর ৬টি উপজেলার পাইকারি বিক্রেতা ও সাপ্লায়ারদের সরাসরি পরিচিতি ও যোগাযোগের সুবিধা।</p>
</div>
​<div className="flex flex-col items-center space-y-3 p-4">
<div className="p-4 bg-blue-50 rounded-full text-blue-600">
<Users size={36} weight="duotone" />
</div>
<h4 className="text-lg font-bold text-[#0B1736]">নিরাপদ ইনভেস্টমেন্ট সুযোগ</h4>
<p className="text-xs text-gray-500">ছোট ও মাঝারি ব্যবসায় স্বচ্ছ চুক্তির ভিত্তিতে শেয়ার বা পার্টনারশিপের সুযোগ।</p>
</div>
</div>
</div>
</section>
...
<span className="text-lg font-bold text-[#FFD700]">FeniX</span>
<span>© 2026 Feni Business Ecosystem. সর্বস্বত্ব সংরক্ষিত।</span>
</div>
<div className="flex items-center space-x-6">
<a href="#" className="hover:text-white transition-colors">শর্তাবলী</a>
<a href="#" className="hover:text-white transition-colors">গোপনীয়তা নীতি</a>
