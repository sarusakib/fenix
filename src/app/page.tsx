  ...
  return (
    <main className="relative min-h-screen overflow-x-hidden bg-[#030506] text-white selection:bg-[#008080]/30">
      ...
      >
        ...
        <div className="absolute inset-0 bg-[#030506]/58" />
        ...
        <div className="absolute inset-x-0 bottom-0 h-[42%] bg-gradient-to-t from-[#030506]/95 via-[#030506]/55 to-transparent" />
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_28%,rgba(0,0,0,0.26)_100%)]" />
      ...
      <div className="relative z-10">
        ...
        {/* =======================================================
            NAVBAR
        ======================================================= */}
        <header className="sticky top-0 z-50 border-b border-white/[0.07] bg-[#030506]/72 backdrop-blur-2xl">
        ...
        <section className="relative">
          ...
          <div className="mx-auto max-w-7xl px-4 pb-16 pt-16 sm:px-6 sm:pb-20 sm:pt-20 lg:px-8 lg:pb-24 lg:pt-28">
            ...
            <div className="mx-auto max-w-4xl text-center">
              ...
              {/* Badge */}
              <div className="mb-7 inline-flex items-center gap-2 rounded-full border border-[#008080]/25 bg-black/32 px-3.5 py-2 text-[11px] font-semibold uppercase tracking-[0.18em] text-[#72ddda] shadow-[0_0_35px_rgba(0,128,128,0.07)] backdrop-blur-xl">
              ...
              <div className="mx-auto mt-9 max-w-2xl">
                <div className="group relative">
                  ...
                  <div className="relative flex min-h-[60px] items-center rounded-2xl border border-white/[0.09] bg-black/42 p-1.5 shadow-[0_20px_80px_rgba(0,0,0,0.38)] backdrop-blur-xl transition duration-300 focus-within:border-[#008080]/40">
                ...
                <div className="mt-4 flex flex-wrap justify-center gap-2">
                  {quickPrompts.map((prompt) => (
                    <button
                      ...
                      className="rounded-full border border-white/[0.07] bg-black/28 px-3 py-1.5 text-[11px] text-white/42 backdrop-blur-md transition duration-300 hover:border-[#008080]/25 hover:bg-[#008080]/[0.05] hover:text-[#72ddda]"
                    >
                      {prompt}
                    </button>
                  ))}
            ...
            {actionCards.map((card) => {
              ...
              return (
                <button
                  ...
                  className={`group relative overflow-hidden rounded-2xl border border-white/[0.08] bg-black/28 p-5 text-left shadow-[0_15px_50px_rgba(0,0,0,0.20)] backdrop-blur-xl transition duration-500 hover:-translate-y-1 hover:bg-white/[0.055] ${accentStyles.hover}`}
                >
                  ...
                  <div className="relative mt-5 flex items-center gap-1 text-xs font-semibold text-white/32 transition duration-300 group-hover:text-white/65">
                    Explore
        ...
        <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 sm:pb-20 lg:px-8">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-white/[0.08] bg-black/28 backdrop-blur-xl">
            ...
            <div className="relative grid gap-10 p-6 sm:p-9 lg:grid-cols-[1.2fr_0.8fr] lg:p-12">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="rounded-2xl border border-white/[0.07] bg-black/26 p-5 backdrop-blur-xl">
                  <Buildings
                    size={24}
        ...
        {/* =======================================================
            TRUST SECTION
        ======================================================= */}
        <section className="border-y border-white/[0.06] bg-black/22 backdrop-blur-xl">
