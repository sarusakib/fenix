...
export default function NewProductPage() {
  ...
  async function handleSubmit(
    ...
    /*
     * Database contract অনুযায়ী
     * name_bn এবং name_en দুটিই required।
     *
     * User যেকোনো একটি নাম দিলে
     * অন্য field-এ সেটির fallback
     * ব্যবহার করা হবে।
     */
    const databaseNameBn =
      cleanNameBn || cleanNameEn

    const databaseNameEn =
      cleanNameEn || cleanNameBn
    ...
    try {
       ...
       * Important:
       *
       * products.Insert অনুযায়ী
       * name_bn এবং name_en string।
       *
       * তাই এখানে null দেওয়া যাবে না।
       */
      const {
        data: createdProduct,
        error: insertError,
      ...
      >
        ...
        <div className="mt-10">
          ...
          <p
            ...
            "
          >
            Product প্রথমে draft হিসেবে
            তৈরি হবে। Image, inventory এবং
            publishing workflow পরবর্তী
            ধাপে যুক্ত হবে।
          </p>
        </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              বা stock পরিবর্তনের permission
              নেই।
            </p>
          </div>
