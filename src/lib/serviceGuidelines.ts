...
const GUIDES: Record<string, FeniXServiceGuideline> = {
  ...
  search: {...common,titleBn:'ফেনিক্সে একসাথে সার্চ',titleEn:'Search FeniX',stepsBn:['কী খুঁজছেন লিখুন','Business, product বা place result দেখুন','প্রয়োজনে category/area দিয়ে refine করুন','সঠিক profile খুলে action নিন'],stepsEn:['Type what you need','Review business, product or place results','Refine by category or area when useful','Open the right profile and act']},
  feed: {...common,titleBn:'কমিউনিটি ফিড',titleEn:'Community Feed',stepsBn:['প্রয়োজনীয় প্রশ্ন বা topic দেখুন','প্রাসঙ্গিক প্রশ্ন খুলুন','প্রয়োজনে নিজের প্রশ্ন/উত্তর দিন','অস্বস্তিকর content হলে report করুন'],stepsEn:['Browse useful questions and topics','Open a relevant question','Ask or answer when useful','Report unsafe or problematic content']},
  profile: {...common,titleBn:'আমার প্রোফাইল',titleEn:'My profile',stepsBn:['নাম ও username ঠিক করুন','Bio, location ও public link যোগ করুন','Privacy ও message preference ঠিক করুন','Public preview দেখে Save করুন'],stepsEn:['Set your name and username','Add bio, location and public link','Choose privacy and message preferences','Review the public preview and save']},
  'qr': {...common,titleBn:'QR বিজনেস আইডি',titleEn:'QR Business Identity',stepsBn:['Directory থেকে business profile খুলুন','Trust/verification তথ্য যাচাই করুন','QR identity খুলুন','Business-এর public profile share করুন'],stepsEn:['Open a business profile from Directory','Review trust and verification context','Open the QR identity','Share the public business profile']},
