 ...
 *
 * Active Commerce routes mirror the current App Router exactly.
 * Route registration does not create pages automatically.
 */
export const ROUTES = {
  home: '/',
  admin: '/admin',
  ...
  ecosystem: { deals: '/deals', jobs: '/jobs', requests: '/requests', messages: '/messages', notifications: '/notifications', payments: '/payments' },
  dashboard: { root: '/dashboard', business: '/dashboard/business', settings: '/dashboard/settings' },
} as const
